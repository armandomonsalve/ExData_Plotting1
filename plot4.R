...
# Plot 1
with(HHPowerC, plot(DateTime, Global_active_power, ylab = "Global Active Power", type = "l"))

# Plot 2
with(HHPowerC, plot(DateTime, Voltage, ylab = "Voltage", type = "l"))
...
# Plot 4
with(HHPowerC, plot(DateTime, Global_reactive_power, ylab = "Global_reactive_power", type = "l"))
